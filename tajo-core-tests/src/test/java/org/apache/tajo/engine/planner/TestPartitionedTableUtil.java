...
public class TestPartitionedTableUtil extends QueryTestCaseBase {
  ...
  private static void createExternalTableIncludedOnePartitionKeyColumn(FileSystem fs, Path rootDir, Schema schema,
    ...
    PartitionMethodDesc partitionMethodDesc =
      new PartitionMethodDesc("TestPartitionedTableUtil", PARTITION_TABLE_NAME,
  ...
  private static void createExternalTableIncludedMultiplePartitionKeyColumns(FileSystem fs, Path rootDir,
    ...
    PartitionMethodDesc partitionMethodDesc =
      new PartitionMethodDesc("TestPartitionedTableUtil", MULTIPLE_PARTITION_TABLE_NAME,
  ...
  public final void testPartitionPruningWitCTAS() throws Exception {
    ...
    String canonicalTableName = CatalogUtil.getCanonicalTableName("\"TestPartitionedTableUtil\"", tableName);
