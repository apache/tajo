...
public class TestHBaseTable extends QueryTestCaseBase {
  ...
  private void assertIndexPredication(boolean isCompositeRowKey) throws Exception {
    ...
    assertEquals("021", new String(((HBaseFragment)fragments.get(0)).getStartKey()));
    assertEquals("021" + postFix, new String(((HBaseFragment)fragments.get(0)).getEndKey()));
    ...
    assertEquals("020", new String(fragment1.getStartKey()));
    assertEquals("040", new String(fragment1.getEndKey()));

    HBaseFragment fragment2 = (HBaseFragment) fragments.get(1);
    assertEquals("040", new String(fragment2.getStartKey()));
    assertEquals("055" + postFix, new String(fragment2.getEndKey()));
    ...
    assertEquals("075", new String(fragment3.getStartKey()));
    assertEquals("075" + postFix, new String(fragment3.getEndKey()));
    ...
    assertEquals("072", new String(fragment3.getStartKey()));
    assertEquals("078" + postFix, new String(fragment3.getEndKey()));
    ...
    fragment2 = (HBaseFragment) fragments.get(1);
    assertEquals("040", new String(fragment2.getStartKey()));
    assertEquals("059" + postFix, new String(fragment2.getEndKey()));
  }
