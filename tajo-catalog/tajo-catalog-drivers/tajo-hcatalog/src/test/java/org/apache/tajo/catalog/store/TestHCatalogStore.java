...
public class TestHCatalogStore {
  ...
  public void testTableUsingTextFile() throws Exception {
    ...
    assertEquals(StringEscapeUtils.escapeJava(StorageConstants.DEFAULT_FIELD_DELIMITER),
        table1.getMeta().getOption(StorageConstants.TEXTFILE_DELIMITER));
  ...
  public void testTableWithNullValue() throws Exception {
    KeyValueSet options = new KeyValueSet();
    options.set(StorageConstants.TEXTFILE_DELIMITER, StringEscapeUtils.escapeJava("\u0002"));
    options.set(StorageConstants.TEXTFILE_NULL, StringEscapeUtils.escapeJava("\u0003"));
    ...
    assertEquals(table.getMeta().getOption(StorageConstants.TEXTFILE_DELIMITER),
        table1.getMeta().getOption(StorageConstants.TEXTFILE_DELIMITER));

    assertEquals(table.getMeta().getOption(StorageConstants.TEXTFILE_NULL),
        table1.getMeta().getOption(StorageConstants.TEXTFILE_NULL));

    assertEquals(table1.getMeta().getOption(StorageConstants.TEXTFILE_DELIMITER),
        StringEscapeUtils.escapeJava("\u0002"));

    assertEquals(table1.getMeta().getOption(StorageConstants.TEXTFILE_NULL),
        StringEscapeUtils.escapeJava("\u0003"));
