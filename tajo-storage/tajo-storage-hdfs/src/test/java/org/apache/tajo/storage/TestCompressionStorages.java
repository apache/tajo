...
public class TestCompressionStorages {
  ...
  private void storageCompressionTest(String storeType, Class<? extends CompressionCodec> codec) throws IOException {
    ...
    Appender appender = ((FileTablespace) TableSpaceManager.getDefault()).getAppender(meta, schema, tablePath);
    ...
    Scanner scanner = TableSpaceManager.getDefault().getScanner(meta, schema, tablets[0], schema);
