...
public class TestMergeScanner {
  ...
  public void testMultipleFiles() throws IOException {
    ...
    Appender appender1 = TableSpaceManager.getByName("local").get().getAppender(null, null, meta, schema, table1Path);
    ...
    Appender appender2 = TableSpaceManager.getByName("local").get().getAppender(null, null, meta, schema, table2Path);
