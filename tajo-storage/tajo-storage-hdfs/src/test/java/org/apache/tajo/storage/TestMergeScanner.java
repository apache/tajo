...
public class TestMergeScanner {
  ...
  public void testMultipleFiles() throws IOException {
    ...
    Appender appender1 = TableSpaceManager.getDefault().getAppender(null, null, meta, schema, table1Path);
    ...
    Appender appender2 = TableSpaceManager.getDefault().getAppender(null, null, meta, schema, table2Path);
