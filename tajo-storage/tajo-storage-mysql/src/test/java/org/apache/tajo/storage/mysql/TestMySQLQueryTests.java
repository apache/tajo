...
public class TestMySQLQueryTests extends QueryTestCaseBase {
...
//  @Test
  ...
  public void testQueryWithConnProperties() throws Exception {
    ...
    try {
      old = MySQLTestServer.resetAllParamsAndSetConnProperties(connProperties);
      runSimpleTests();
    } finally {
      if (old.isPresent()) {
