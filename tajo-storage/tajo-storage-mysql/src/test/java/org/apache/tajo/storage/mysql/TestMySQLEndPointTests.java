...
public class TestMySQLEndPointTests extends QueryTestCaseBase {
  ...
  public void testGetAllDatabaseNames() {
    ...
    assertTrue(retrieved.contains(MySQLTestServer.DATABASE_NAME));
  }

  @Test(timeout = 1000)
  public void testGetTableList() {
    final Set<String> expected = Sets.newHashSet(MySQLTestServer.TPCH_TABLES);
  ...
  public void testGetTable() throws UndefinedTableException {
    for (String tableName: MySQLTestServer.TPCH_TABLES) {
      TableDesc retrieved = client.getTableDesc(MySQLTestServer.DATABASE_NAME + "." + tableName);
      assertEquals(MySQLTestServer.DATABASE_NAME + "." + tableName, retrieved.getName());
