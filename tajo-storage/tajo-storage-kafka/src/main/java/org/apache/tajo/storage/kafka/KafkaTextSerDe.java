...
public class KafkaTextSerDe extends TextLineSerDe {
  @Override
  public TextLineDeserializer createDeserializer(Schema schema, TableMeta meta, Column[] targetColumnIndexes) {
  ...
  public static byte getFieldDelimiter(TableMeta meta) {
    return StringEscapeUtils.unescapeJava(meta.getProperty(StorageConstants.TEXT_DELIMITER,
        StorageConstants.DEFAULT_FIELD_DELIMITER)).getBytes(Bytes.UTF8_CHARSET)[0];
  }
}
