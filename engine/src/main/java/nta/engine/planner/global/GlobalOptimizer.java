...
//    }
//    query = graph.getRoot();
//    while (query.getNextQueries().size() > 0) {
...
//    int outputNum = -1, maxOutputNum = query.getPrevQueries().size();
//
...
//      if (query.getNextQueries().size() > 0) {
//        prevIt = query.getNextQueries().iterator();
//        while (prevIt.hasNext()) {
//          prevQuery = prevIt.next();
//          prevQuery.removePrevQuery(query);
...
//            }
//            prevQuery = prevIt.next();
//            curQuery.addNextQuery(prevQuery);
//            prevQuery.addPrevQuery(curQuery);
//          }
...
//        }
//        prevQuery = prevIt.next();
//        curQuery.removeNextQuery(query);
//        curQuery.addNextQuery(prevQuery);
//        prevQuery.addPrevQuery(curQuery);
//      }
//    }
