...
public class ZkUtil {
	 ...
	 */
	public static void createAndFailSilent(ZkClient zk,
		String znode) throws KeeperException, InterruptedException {	    	      
