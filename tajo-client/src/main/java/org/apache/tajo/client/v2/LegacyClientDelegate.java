...
public class LegacyClientDelegate extends SessionConnection implements ClientDelegate {
   ...
   */
  public LegacyClientDelegate(ServiceTracker tracker, @Nullable String baseDatabase, KeyValueSet properties)
      throws SQLException {
   ...
   * @throws java.io.IOException
   */
  public LegacyClientDelegate(InetSocketAddress addr, @Nullable String baseDatabase, KeyValueSet properties)
      throws SQLException {
    this(new DummyServiceTracker(addr), baseDatabase, properties);
  }

  public LegacyClientDelegate(ServiceTracker serviceTracker) throws SQLException {
    this(serviceTracker, null);
  }

  public LegacyClientDelegate(ServiceTracker serviceTracker, @Nullable String baseDatabase) throws SQLException {
