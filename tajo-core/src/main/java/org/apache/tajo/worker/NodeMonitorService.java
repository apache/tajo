...
public class NodeMonitorService extends AbstractService implements EventHandler<NodeResourceEvent> {
  private static final Log LOG = LogFactory.getLog(NodeMonitorService.class);
  ...
  public NodeMonitorService(TajoWorker.WorkerContext context, Dispatcher dispatcher){
    super(NodeMonitorService.class.getName());
