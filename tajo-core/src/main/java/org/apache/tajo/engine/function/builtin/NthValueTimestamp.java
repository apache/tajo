...
@Description(
    ...
    paramTypes = {@ParamTypes(paramTypes = {TajoDataTypes.Type.TIMESTAMP, TajoDataTypes.Type.INT4})}
)
public class NthValueTimestamp extends NthValue {

  public NthValueTimestamp() {
    super(new Column[] {
