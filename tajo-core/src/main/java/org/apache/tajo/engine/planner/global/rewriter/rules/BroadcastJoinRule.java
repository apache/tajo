...
public class BroadcastJoinRule implements GlobalPlanRewriteRule {
  ...
  private class BroadcastJoinPlanBuilder implements DirectedGraphVisitor<ExecutionBlockId> {
    ...
    @Override
    public void visit(Stack<ExecutionBlockId> stack, ExecutionBlockId executionBlockId) throws TajoException {
     ...
     * @param current
     */
    private void visitNonLeafNode(ExecutionBlock current) throws TajoException {
