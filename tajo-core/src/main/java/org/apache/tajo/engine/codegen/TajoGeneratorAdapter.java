  ...
  public void castInsn(TajoDataTypes.DataType srcType, TajoDataTypes.DataType targetType) {
    ...
    case CHAR: {
      if (srcType.hasLength() && srcType.getLength() == 1) {
        ...
        default:
          throw new TajoRuntimeException(new InvalidCastException(srcType, targetType));
        }
      } else {
        ...
        case TEXT: break;
        default: throw new TajoRuntimeException(new InvalidCastException(srcType, targetType));
        }
      }
      break;
    }
