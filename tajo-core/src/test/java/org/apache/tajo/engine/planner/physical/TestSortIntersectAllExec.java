...
public class TestSortIntersectAllExec {
  ...
  public void setUp() throws Exception {
    ...
    TableMeta employeeMeta1 = CatalogUtil.newTableMeta(CatalogProtos.StoreType.CSV);
    ...
    TableMeta employeeMeta2 = CatalogUtil.newTableMeta(CatalogProtos.StoreType.CSV);
