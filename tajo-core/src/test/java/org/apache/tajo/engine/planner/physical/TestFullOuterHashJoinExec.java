...
public class TestFullOuterHashJoinExec {
  ...
  private static final String TEST_PATH = TajoTestingCluster.DEFAULT_TEST_DIRECTORY + "/TestFullOuterHashJoinExec";
  ...
  private static final String DATABASENAME = "testfullouterhashjoinexec";
  ...
  String[] QUERIES = {
      // [0] no nulls
      String.format("select dep3.dep_id, dep_name, emp_id, salary from %s.dep3 full outer join %s.emp3 on %s.dep3.dep_id = %s.emp3.dep_id",
      ...
      String.format("select emp3.emp_id, first_name, phone_number from %s.emp3 full outer join %s.phone3 on %s.emp3.emp_id = %s.phone3.emp_id",
          DATABASENAME, DATABASENAME, DATABASENAME, DATABASENAME),
  };
