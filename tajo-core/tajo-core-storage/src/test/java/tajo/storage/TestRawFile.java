...
import tajo.storage.RawFile.Appender;
import tajo.storage.RawFile.Scanner;
...
public class TestRawFile {
  ...
  public void testRawFile() throws IOException {
    ...
    Appender appender = new RawFile.Appender(conf, meta, path);
    appender.init();
    int tupleNum = 10000;
    VTuple vTuple;
    ...
    Scanner scanner = new Scanner(conf, meta, path);
    scanner.init();
    int tupleCnt = 0;
