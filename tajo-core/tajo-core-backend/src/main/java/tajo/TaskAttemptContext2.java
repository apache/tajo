 ...
 *
 */
public class TaskAttemptContext2 {
  private static final Log LOG = LogFactory.getLog(TaskAttemptContext2.class);
  ...
  public TaskAttemptContext2(TajoConf conf, final QueryUnitAttemptId queryId,
  ...
  public boolean equals(Object obj) {
    if (obj instanceof TaskAttemptContext2) {
      TaskAttemptContext2 other = (TaskAttemptContext2) obj;
