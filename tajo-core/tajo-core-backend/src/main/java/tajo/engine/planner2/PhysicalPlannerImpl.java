...
import tajo.engine.planner2.physical.*;
...
public class PhysicalPlannerImpl implements PhysicalPlanner {
  ...
  public PhysicalExec createPlan(final TaskAttemptContext2 context,
  ...
  private PhysicalExec createPlanRecursive(TaskAttemptContext2 ctx, LogicalNode logicalNode) throws IOException {
    PhysicalExec outer;
    PhysicalExec inner;
  ...
  private long estimateSizeRecursive(TaskAttemptContext2 ctx, String [] tableIds) {
    long size = 0;
  ...
  public PhysicalExec createJoinPlan(TaskAttemptContext2 ctx, JoinNode joinNode,
  ...
  public PhysicalExec createStorePlan(TaskAttemptContext2 ctx,
  ...
  public PhysicalExec createScanPlan(TaskAttemptContext2 ctx, ScanNode scanNode)
      throws IOException {
  ...
  public PhysicalExec createGroupByPlan(TaskAttemptContext2 ctx,
  ...
  public PhysicalExec createSortPlan(TaskAttemptContext2 ctx, SortNode sortNode,
                                     PhysicalExec subOp) throws IOException {
    return new ExternalSortExec(ctx, sm, sortNode, subOp);
  }

  public PhysicalExec createIndexWritePlan(StorageManager sm,
                                           TaskAttemptContext2 ctx, IndexWriteNode indexWriteNode, PhysicalExec subOp)
      throws IOException {
  ...
  public PhysicalExec createIndexScanExec(TaskAttemptContext2 ctx,
