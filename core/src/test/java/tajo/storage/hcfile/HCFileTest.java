...
import tajo.storage.CSVFile.CSVScanner;
...
public class HCFileTest {
  ...
  public void testInt()
    ...
    ColumnMeta meta = new HColumnMetaWritable(0, DataType.INT, CompressType.COMP_NONE,
        false, false, true);
    long before = System.currentTimeMillis();
    HCFile.Appender appender = new Appender(conf, meta, path);
    ...
    HCFile.Scanner scanner = new Scanner(conf, path);
