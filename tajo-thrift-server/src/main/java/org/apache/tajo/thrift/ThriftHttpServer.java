 ...
 */
public class ThriftHttpServer {
  private static final Log LOG = LogFactory.getLog(ThriftHttpServer.class);
  ...
  public ThriftHttpServer(String name, String bindAddress, int port,
  ...
  public Connector createBaseListener(Configuration conf) throws IOException {
    return ThriftHttpServer.createDefaultChannelConnector();
  }
