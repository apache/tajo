...
public class TajoGetConfCommand extends TajoThriftShellCommand {
  private TajoGetConf getconf;

  public TajoGetConfCommand(TajoThriftCliContext context) {
    super(context);
    getconf = new TajoGetConf(context.getConf(), context.getOutput(), context.getTajoThriftClient());
  }
