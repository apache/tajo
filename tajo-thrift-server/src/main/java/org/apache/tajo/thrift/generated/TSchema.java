...
public class TSchema implements org.apache.thrift.TBase<TSchema, TSchema._Fields>, java.io.Serializable, Cloneable, Comparable<TSchema> {
  ...
  static {
    schemes.put(StandardScheme.class, new TSchemaStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TSchemaTupleSchemeFactory());
  }
  ...
  public TSchema setColumns(List<TColumn> columns) {
    this.columns = columns;
    return this;
  }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TSchema(");
    boolean first = true;
  ...
  private static class TSchemaStandardSchemeFactory implements SchemeFactory {
    public TSchemaStandardScheme getScheme() {
      return new TSchemaStandardScheme();
    }
  }

  private static class TSchemaStandardScheme extends StandardScheme<TSchema> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TSchema struct) throws TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TSchema struct) throws TException {
      struct.validate();
  ...
  private static class TSchemaTupleSchemeFactory implements SchemeFactory {
    public TSchemaTupleScheme getScheme() {
      return new TSchemaTupleScheme();
    }
  }

  private static class TSchemaTupleScheme extends TupleScheme<TSchema> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TSchema struct) throws TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TSchema struct) throws TException {
