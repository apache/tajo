...
public class TColumn implements org.apache.thrift.TBase<TColumn, TColumn._Fields>, java.io.Serializable, Cloneable, Comparable<TColumn> {
  ...
  private static final org.apache.thrift.protocol.TField SQL_DATA_TYPE_FIELD_DESC = new org.apache.thrift.protocol.TField("sqlDataType", org.apache.thrift.protocol.TType.I32, (short)6);
  ...
  public int sqlDataType; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    SQL_DATA_TYPE((short)6, "sqlDataType");
  ...
  private static final int __SQLDATATYPE_ISSET_ID = 1;
  ...
  static {
    ...
    tmpMap.put(_Fields.SQL_DATA_TYPE_NAME, new org.apache.thrift.meta_data.FieldMetaData("sqlDataTypeName", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.SQL_DATA_TYPE, new org.apache.thrift.meta_data.FieldMetaData("sqlDataType", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
  ...
  public TColumn(TColumn other) {
    ...
    this.sqlDataType = other.sqlDataType;
  }
  ...
  public TColumn setDataType(int dataType) {
    this.dataType = dataType;
    setDataTypeIsSet(true);
    return this;
  }
  ...
  public TColumn setSqlDataType(int sqlDataType) {
    this.sqlDataType = sqlDataType;
    setSqlDataTypeIsSet(true);
    return this;
  }
  ...
  public void unsetSqlDataType() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __SQLDATATYPE_ISSET_ID);
  }

  /** Returns true if field sqlDataType is set (has been assigned a value) and false otherwise */
  public boolean isSetSqlDataType() {
    return EncodingUtils.testBit(__isset_bitfield, __SQLDATATYPE_ISSET_ID);
  }

  public void setSqlDataTypeIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __SQLDATATYPE_ISSET_ID, value);
  }
  ...
  public boolean equals(TColumn that) {
    ...
    boolean this_present_sqlDataType = true;
    boolean that_present_sqlDataType = true;
    if (this_present_sqlDataType || that_present_sqlDataType) {
      if (!(this_present_sqlDataType && that_present_sqlDataType))
        return false;
      if (this.sqlDataType != that.sqlDataType)
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_sqlDataType = true;
    list.add(present_sqlDataType);
    if (present_sqlDataType)
  ...
  public int compareTo(TColumn other) {
    ...
    lastComparison = Boolean.valueOf(isSetSqlDataType()).compareTo(other.isSetSqlDataType());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSqlDataType()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.sqlDataType, other.sqlDataType);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class TColumnStandardScheme extends StandardScheme<TColumn> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TColumn struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 6: // SQL_DATA_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.sqlDataType = iprot.readI32();
              struct.setSqlDataTypeIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TColumn struct) throws org.apache.thrift.TException {
      ...
      oprot.writeFieldBegin(SQL_DATA_TYPE_FIELD_DESC);
      oprot.writeI32(struct.sqlDataType);
      oprot.writeFieldEnd();
