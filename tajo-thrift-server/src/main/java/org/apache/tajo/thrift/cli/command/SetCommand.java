...
public class SetCommand extends TajoThriftShellCommand {

  public SetCommand(TajoThriftCliContext context) {
    super(context);
  }
  ...
  private void showAllSessionVars() throws Exception {
  ...
  private void updateSessionVariable(String key, String val) throws Exception {
