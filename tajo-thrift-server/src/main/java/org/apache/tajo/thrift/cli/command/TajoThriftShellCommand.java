...
public abstract class TajoThriftShellCommand {
  ...
  protected TajoThriftCliContext context;
  protected TajoThriftClient client;
  protected int maxColumn;

  public TajoThriftShellCommand(TajoThriftCliContext context) {
    maxColumn = context.getConf().getIntVar(TajoConf.ConfVars.$CLI_MAX_COLUMN);
    this.context = context;
    client = context.getTajoThriftClient();
  }
