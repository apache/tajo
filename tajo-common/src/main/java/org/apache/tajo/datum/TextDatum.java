...
public class TextDatum extends Datum {
  ...
  public boolean asBool() {
    throw new TajoRuntimeException(new InvalidCastException(TajoDataTypes.Type.TEXT, TajoDataTypes.Type.BOOLEAN));
  }

  @Override
  public byte asByte() {
    throw new TajoRuntimeException(new InvalidCastException(TajoDataTypes.Type.TEXT, TajoDataTypes.Type.BIT));
  }
