...
public class TestSchema {
  ...
  public final void testSchema1() {
    Field struct1 = StructField($("f12"), Field($("f1"), Int8), Field($("f2"), Int4));
    Field struct2 = StructField($("f34"), Field($("f3"), Int8), Field($("f4"), Int4));
  ...
  public final void testSchema2() {
    ...
    Field f3 = StructField($("z"), Field($("z-1"), Time), Field($("z-2"), Array(Int8)));
