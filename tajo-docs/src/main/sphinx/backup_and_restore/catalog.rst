...
For example, if you want to backup a table customer, you should type a command as follows: ::
  ...
  --
  CREATE EXTERNAL TABLE customer (c_custkey INT8, c_name TEXT, c_address TEXT, c_nationkey INT8, c_phone TEXT, c_acctbal FLOAT8, c_mktsegment TEXT, c_comment TEXT) USING TEXT WITH ('text.delimiter'=',') LOCATION 'file:/home/hyunsik/tpch/customer';
