...
.. code-block:: sh
  ...
  export TAJO_CLASSPATH=/usr/local/mysql/lib/mariadb-java-clinet-x.x.x.jar
...
.. code-block:: xml
  ...
  <property>
    <name>tajo.catalog.jdbc.uri</name>
    <value>jdbc:mariadb://<mysql host name>:<mysql port>/<database name for tajo>?createDatabaseIfNotExist=true</value>
  </property>
